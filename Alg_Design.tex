...
After implementing the quaternion and velocity corrections developed above, the measurement vector is augmented with the new pseudovelocity:
%
\begin{equation}
...
%
\begin{equation}
h \left( \mathbf{x}_{k} \right) = \mathbf{I}_{10 \times 10} \mathbf{z}_{k}
\end{equation}
\todo{check with Sam}
